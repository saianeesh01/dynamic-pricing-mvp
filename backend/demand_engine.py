...
class PriceOptimizer:
    """
    Optimizes price to maximize revenue = price × predicted_demand(price).
    """
    
    def __init__(self, demand_model: DemandPredictionModel):
    ...
    def optimize_price(
        ...
        Returns:
            Dictionary with optimal price, predicted demand, revenue, and alternatives
        """
        # Set price bounds
